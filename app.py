...
def city_analysis(data, opt, opt1):
    ...
    with col4:
        col4.container(border = True).metric("Avg Daily Sales", round(data.groupby("Date")["Total"].mean().mean(), 2))
...
if option1 == "Overall":
    ...
    if opt1 == "Combined":
        ...
        overall_analysis(df[df["Month"] == month_dict[opt1]], opt1)
...
if option1 == "City":
    ...
    if opt1 == "Combined":
        ...
        city_analysis(city_df[city_df["Month"] == month_dict[opt1]], opt, opt1)
...
if option1 == "Product Line":
    ...
    if opt1 == "Combined":
        ...
        product_line_analysis(product_df[product_df["Month"] == month_dict[opt1]], opt, opt1)